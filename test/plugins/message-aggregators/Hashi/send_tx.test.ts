...
import { script_interface } from '@benchmarking-bridge-aggregators/plugins/message-aggregators/Hashi/dispatcher';

import { Hashi_Contract_Names } from '@benchmarking-bridge-aggregators/plugins/message-aggregators/Hashi/constants_local';
